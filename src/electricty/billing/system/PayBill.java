...
public class PayBill extends JFrame implements ActionListener {
    ...
    PayBill(String meter) {
        ...
        heading.setBackground(new Color(151, 162, 209));
        ...
        meternumber.setBounds(300, 80, 400, 20);
        add(meternumber);
       ...
       getContentPane().setBackground(new Color(198, 207, 247));
